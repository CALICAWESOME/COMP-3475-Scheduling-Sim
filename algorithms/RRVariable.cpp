...
#include <iostream>
#include <sstream>
#include "RRVariable.h"

//////////////////////////////////
// VARIABLE-QUANTUM ROUND ROBIN //
//////////////////////////////////
vector<process> RRVariable(vector<process> inputList, int quantum, sillytui tui) {
    ...
    for (int time = 0, numProc = inputList.size(); finished.size() < numProc; time++) {
        ...
        if (currentProcess == &process::CPUIDLE && !waitQueue.empty()) {
